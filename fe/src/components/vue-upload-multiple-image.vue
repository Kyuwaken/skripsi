            ...
            <div v-else @dragover.prevent="onDragover">
                ...
                <div class="image-bottom display-flex position-absolute full-width align-items-center justify-content-between"
                    ...
                    <div class="image-bottom-left display-flex align-items-center" v-if="showPrimary">
                        ...
                        <a class="text-small mark-text-primary cursor-pointer"
...
export default {
    ...
    props: {
        dragText: {
            type: String,
            default: 'Drag pictures'
        },
        browseText: {
            type: String,
            default: 'Browse picture(s)'
        },
        primaryText: {
            type: String,
            default: 'Default'
    ...
    methods: {
        ...
        editImage(file) {
            ...
            reader.readAsDataURL(file)
            this.$emit('edit-image', formData, this.currentIndexImage, this.images, this.files)
        },
        uploadFieldChange(e) {
        ...
        deleteImage(currentIndex) {
            ...
            console.log('ini di component ', this.files)
        },
        openGallery(index) {
