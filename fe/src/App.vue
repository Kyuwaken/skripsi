<template>
  <v-app>
    <v-app-bar app color="white" flat>
      ...
      <Header v-if="tes.role=='Customer'"></Header>
      <HeaderSeller v-if="tes.role=='Seller'"></HeaderSeller>
    </v-app-bar>
    <v-main>
      <router-view
        :baseURL="baseURL"
...
export default {
  ...
  mixins: [crypto],
  created(){
    this.tes = this.decryptLocalStorage(localStorage.getItem('encryptedData'))
  },
