...
class LoginView(APIView):
    def post(self, request):
        ...
        #     user['id'] = None
        # Generate jwt
        # if user_type.lower() == RoleEnum.USER.value.lower():
        jwt = generate_token(user.id, username, user_info['display_name'], user_info['role'], user_info['eselon'], user_info['initial'], user_info['ithc_biro'], user_info['group'], user_info['subgroup'])
        # else:
