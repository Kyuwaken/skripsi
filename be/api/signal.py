...
model_classes = [Cart, Category, Country, Courier, Favorite, MasterStatus, PaymentMethod, Payment, PaymentType, Product, ProductReview, Role, TransactionDetail, Transaction, TransactionStatus, User]
